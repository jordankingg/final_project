...
VALUES ('What does the method, console.log() do in JavaScript?', 'js',  "Opens your computer\'s terminal", 'Logs a message to the console', 'Prints out all local variables', 'Nothing', 'A');
...
INSERT INTO examQuestionInfo (question, question_type, choice_a, choice_b, choice_c, choice_d, correct_answer)
VALUES ('Which of the following displays a dialog with an optional message prompting the user to input text in JavaScript?', 'js',  "prompt(message, default);", 'Console.log(message);', 'alert(message);', 'confirm();', 'A');

INSERT INTO examQuestionInfo (question, question_type, choice_a, choice_b, choice_c, choice_d, correct_answer)
VALUES ('Variables are declared in JavaScript with which of the following keywords?', 'js',  "new", 'variable', 'js', 'var', 'D');

INSERT INTO examQuestionInfo (question, question_type, choice_a, choice_b, choice_c, choice_d, correct_answer)
VALUES ('In PHP, Why would you use GET over POST?', 'php',  "GET URLs can be bookmarked", 'Parameters are not saved in browser history.', 'GET is more secure than POST', 'There are no restrictions on URL length', 'A');
...
INSERT INTO examQuestionInfo (question, question_type, choice_a, choice_b, choice_c, choice_d, correct_answer)
VALUES ('What is $_SESSION[]\'s purpose in PHP?', 'php',  "It is used to register a global variable ", "It is used to to initialize a session", "It is used to store variables in the current session ", 'None of the above', 'C');
/*
